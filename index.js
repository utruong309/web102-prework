...
// update the gamesCard with the total number of games
...
// Function to display games on the page (this function will be reused)
function displayGames(games) {
    games.forEach(game => {
        const gameElement = document.createElement("div");
        gameElement.classList.add("game");

        // Customize how the game data is displayed
...
const unfundedMessage = unfundedGamesCount === 1
    ? `There is 1 unfunded game.`
    : `There are ${unfundedGamesCount} unfunded games.`;

// create a new DOM element containing the template string and append it to the description container
const messageElement = document.createElement("p");
messageElement.innerHTML = `${unfundedMessage} Explore our exciting games and support them!`;
